...
public class Cliente  implements Serializable{
	...
	public Cliente(final String primerNombre, final String segundoNombre, final String primerApellido, final String segundoApellido,
			final String apellidoCasada, final Calendar fechaNacimiento, final Calendar fechaAniversario, final String horaLocalizacion,
			final String direccion, final String email, final String celular, final String telefonoCasa, final String telefonoOficina, final String telefonoConyuge, final String fotografia,
			final RangoEdad rangoEdad, final TonoBase tonoBase, final TipoLabios tipoLabios, final FormaCara formaCara, final TipoPiel tipoPiel, final TonoPiel tonoPiel,
			final ColorCabello colorCabello, final ColorOjos colorOjos, final Calendar fechaClientePreferido, final String referidoPor) {
	...
	public String toString() {
		return "Cliente [id=" + id + ", primerNombre=" + primerNombre + ", segundoNombre=" + segundoNombre
				...
				+ apellidoCasada + ", fechaNacimiento=" + fechaNacimiento + ", fechaAniversario=" + fechaAniversario
				+ ", horaLocalizacion=" + horaLocalizacion + ", direccion=" + direccion + ", email=" + email
				+ ", celular=" + celular + ", telefonoCasa=" + telefonoCasa + ", telefonoOficina=" + telefonoOficina
