...
public class ClienteForTestsRepository {
	...
	public static Cliente lucia() {
		...
		return new Cliente(consultoraWithId(mary(),1L) , "Lucia", "Isabel", "Navarijo", "Bachez", "Reina", fechaNacimiento, fechaAniversario, "15:00",
	...
	public static Cliente maria() {
		...
		return new Cliente(consultoraWithId(mary(),1L), "Maria", "Claudia", "Pineda", "Osorio", "Reina", fechaNacimiento, fechaAniversario, "10:00",
	...
	public static Cliente enieytilde() {
		...
		return new Cliente(consultoraWithId(mary(),1L), "Aná", "Mariá", "Iñarratu", "Lopez", "Martinez", fechaNacimiento, fechaAniversario, "10:00",
