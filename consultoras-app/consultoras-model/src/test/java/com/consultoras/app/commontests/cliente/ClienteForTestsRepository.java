...
public class ClienteForTestsRepository {
	...
	public static Cliente lucia() {
		...
		return new Cliente("Lucia", "Isabel", "Navarijo", "Bachez", "Reina", fechaNacimiento, fechaAniversario, "15:00",
				"24 Avenida 26-71 Zona 16, Portal de San Isidro Residencias, Guatemala", "lisabelnavarijo@gmail.com",
				"4769-2191", "2219-5470", "2229-2500", "5575-2615", "/images/foto001.jpg", RangoEdad.Treintas,
	...
	public static Cliente maria() {
		...
		return new Cliente("Maria", "Claudia", "Pineda", "Osorio", "Reina", fechaNacimiento, fechaAniversario, "10:00",
				"10 Calle A 19-09 Zona 17, Colonia Lomas del Norte, Guatemala", "marygacelas@yahoo.com", "5555-3799",
				"2256-1772", null, null, "/images/foto001.jpg", RangoEdad.Sesentas, TonoBase.Bronze, TipoLabios.Fino,
	...
	public static Cliente enieytilde() {
		...
		return new Cliente("Aná", "Mariá", "Iñarratu", "Lopez", "Martinez", fechaNacimiento, fechaAniversario, "10:00",
				"20 Calle 11-29 Zona 19, Colonia Primero de Julio, Guatemala", "inarratu@gmail.com", "7545-7756",
				"2445-7756", "2254-4546", "4464-4646", "/images/foto001.jpg", RangoEdad.Cuarentas, TonoBase.Ivory,
